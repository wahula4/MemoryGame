...
/* function shuffleClasses() {
    ...
    var matches = container.querySelectorAll("li.card > i");
    matches.forEach(function(e) {
        let classIndex = Math.floor(Math.random() * cardClasses.length);
        e.classList.add(cardClasses[classIndex]);
    });
}
shuffleClasses(); */
/*
...
inputs.forEach(function(input) {
 ...
 //document.querySelector("li").addEventListener("click", flip);
